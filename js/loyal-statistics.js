...
document.getElementById("bottom-senate-loyalty").appendChild(dataleast(least(sortedobjloy),"total_votes", "votes_with_party_pct", "url"));
...
document.getElementById("most-senate-loyalty").appendChild(dataleast(least(sortedobjloyrev), "total_votes", "votes_with_party_pct", "url"));
